...
const editUser = async (id) => {
  ...
  document.getElementById("s_id").value = response.s_id;
  document.getElementById("s_name").value = response.s_name;
  document.getElementById("s_details").value = response.s_details;
  document.getElementById("s_credit").value = response.s_credit;
};
