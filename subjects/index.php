          ...
          <div class="modal-body">
            <form id="add-user-form" class="p-2" novalidate>
              <div class="row mb-3 gx-3">
                <div class="col">
                  <input type="number" name="s_id" class="form-control form-control-lg" placeholder="Enter ID" required>
                  <div class="invalid-feedback">ID is required!</div>
                </div>

                <div class="col">
                  <input type="text" name="s_name" class="form-control form-control-lg" placeholder="Enter Subject Name" required>
                  <div class="invalid-feedback">Subject name is required!</div>
                </div>
              </div>

              <div class="mb-3">
                <input type="text" name="s_details" class="form-control form-control-lg" placeholder="Enter Details">
                <div class="invalid-feedback">Details is required!</div>
              </div>

              <div class="mb-3">
                <input type="number" name="s_credit" class="form-control form-control-lg" placeholder="Enter Credit" required>
              ...
              <div class="mb-3">
                <input type="submit" value="Add Subject" class="btn addbtn btn-block btn-lg" id="add-user-btn">
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="modal-content actionmod">
          ...
          <div class="modal-body">
            <form id="edit-user-form" class="p-2" novalidate>
              ...
              <div class="row mb-3 gx-3">
                <div class="col">
                  <input type="number" name="s_id" id="s_id" class="form-control form-control-lg" placeholder="Enter ID" required>
                  <div class="invalid-feedback">ID is required!</div>
                </div>

                <div class="col">
                  <input type="text" name="s_name" id="s_name" class="form-control form-control-lg" placeholder="Enter Subject Name" required>
                  <div class="invalid-feedback">Full name is required!</div>
                </div>
              </div>

              <div class="mb-3">
                <input type="text" name="s_details" id="s_details" class="form-control form-control-lg" placeholder="Enter Subject details">
                <div class="invalid-feedback">Detail is required!</div>
              </div>

              <div class="mb-3">
                <input type="number" name="s_credit" id="s_credit" class="form-control form-control-lg" placeholder="Enter Subject Credit" required>
                <div class="invalid-feedback">Credit is required!</div>
              </div>
              ...
              <div class="mb-3">
                <input type="submit" value="Update Subject" class="btn editbtn btn-block btn-lg" id="edit-user-btn">
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row mt-4">
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
          <div>
            <h4 class="text-dark">Subject Dashboard!</h4>
          </div>
          <div>
            <?php 
            if ($_SESSION['role'] == 'super_admin'){
              echo '<button class="btn addbtn" type="button" data-toggle="modal" data-target="#addNewUserModal">Add Subject</button>';
            };
            ?>
          </div>
        </div>
